...
const getBasePath = () => {
  return process.env.NODE_ENV === 'production' ? '/tree-services-website' : '';
};

export const imageConfig = {
  // Homepage images
  hero: {
    main: `${getBasePath()}/images/hero/main-hero.jpg`,
  ...
  treeTrimming: {
    hero: {
      url: `${getBasePath()}/images/pages/tree-trimming/hero.jpg`,
      alt: "Professional tree trimming and pruning",
      fallback:
        "https://via.placeholder.com/800x400?text=Tree+Trimming+Service",
    },
    techniques: {
      url: `${getBasePath()}/images/pages/tree-trimming/techniques.jpg`,
