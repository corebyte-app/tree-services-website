...
export const imageConfig = {
  ...
  treeTrimming: {
    hero: {
      ...
      fallback: "https://via.placeholder.com/800x400?text=Tree+Trimming+Service"
    },
    techniques: {
  ...
  stumpGrinding: {
    hero: {
      ...
      fallback: "https://via.placeholder.com/800x400?text=Stump+Grinding+Service"
    },
    equipment: {
      url: "/images/pages/stump-grinding/equipment.jpg",
      alt: "Professional stump grinding equipment",
      fallback: "https://via.placeholder.com/600x400?text=Stump+Grinding+Equipment"
    },
    beforeAfter: {
      url: "/images/pages/stump-grinding/before-after.jpg",
      alt: "Before and after stump removal comparison",
      fallback: "https://via.placeholder.com/600x300?text=Before+After+Stump+Removal"
    }
  }
};
